...
sim_state_1 = ContinuousNaturalisticEnvironment(env, realistic_bouts=True, draw_screen=False, new_simulation=True,
                                                using_gpu=False)
sim_state_2 = ContinuousNaturalisticEnvironment(env2, realistic_bouts=True, draw_screen=False, new_simulation=True,
                                                using_gpu=False)
sim_state_3 = ContinuousNaturalisticEnvironment(env3, realistic_bouts=True, draw_screen=False, new_simulation=True,
                                                using_gpu=False)
sim_state_4 = ContinuousNaturalisticEnvironment(env4, realistic_bouts=True, draw_screen=False, new_simulation=True,
                                                using_gpu=False)
q = False
d = False
