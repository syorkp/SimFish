 ...
 *     cdef Py_ssize_t num_rays = xmat.shape[0]
 */
  __pyx_tuple__26 = PyTuple_Pack(16, __pyx_n_s_xmat, __pyx_n_s_ymat, __pyx_n_s_im, __pyx_n_s_nrows, __pyx_n_s_ncols, __pyx_n_s_dark_gain, __pyx_n_s_light_gain, __pyx_n_s_bkg_scatter, __pyx_n_s_dark_col, __pyx_n_s_i, __pyx_n_s_c, __pyx_n_s_num_rays, __pyx_n_s_res, __pyx_n_s_result_view, __pyx_n_s_r, __pyx_n_s_r_view); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 105, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(9, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ray_cast_pyx, __pyx_n_s_rays, 105, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 105, __pyx_L1_error)
