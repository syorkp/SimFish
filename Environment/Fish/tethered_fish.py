...
class TetheredFish(Fish):
    ...
    def __init__(self, board, env_variables, dark_col, realistic_bouts, new_simulation):
        super().__init__(board, env_variables, dark_col, realistic_bouts, new_simulation)
