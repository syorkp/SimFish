...
from Buffers.PPO.ppo_buffer_discrete2 import PPOBufferDiscrete2
...
class PPOTrainingServiceDiscrete2(TrainingService, DiscretePPO):
    ...
    def step_loop(self, o, internal_state, a, rnn_state_actor, rnn_state_actor_ref, rnn_state_critic,
        ...
        if self.full_logs:
            return self._training_step_loop_full_logs2(o, internal_state, a, rnn_state_actor,
                                                      rnn_state_actor_ref, rnn_state_critic,
                                                      rnn_state_critic_ref)
        else:
            return self._training_step_loop_reduced_logs2(o, internal_state, a, rnn_state_actor,
                                                         rnn_state_actor_ref, rnn_state_critic,
                                                         rnn_state_critic_ref)
