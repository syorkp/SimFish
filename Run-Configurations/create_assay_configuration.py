...
indiscriminate_ablation_gradient2 = [
    {
        "Model Name": "even_prey_ref",
        "Environment Name": "prey_only",
        "Trial Number": 7,
        ...
        "Assays": [
            {
                ...
                "collisions": True,
                "recordings": ["consumed", "predator", "behavioural choice"],
                "ablations": placeholder_list[:int((19.2 *len(placeholder_list)) / 20)],
            },
            {
                "assay id": "Ablated-96-2",
                "stimulus paradigm": "Naturalistic",
                "duration": 500,
                "Tethered": False,
                "save frames": True,
        ...
        "Assays": [
            {
                ...
                "collisions": True,
                "recordings": ["consumed", "predator", "behavioural choice"],
                "ablations": placeholder_list[:int((19.4 *len(placeholder_list)) / 20)],
            },
            {
                "assay id": "Ablated-97-2",
                "stimulus paradigm": "Naturalistic",
                "duration": 500,
                "Tethered": False,
                "save frames": True,
        ...
        "Assays": [
            {
                ...
                "collisions": True,
                "recordings": ["consumed", "predator", "behavioural choice"],
                "ablations": placeholder_list[:int((19.6 *len(placeholder_list)) / 20)],
            },
            {
                "assay id": "Ablated-98-2",
                "stimulus paradigm": "Naturalistic",
                "duration": 500,
                "Tethered": False,
                "save frames": True,
        ...
        "Assays": [
            {
                ...
                "collisions": True,
                "recordings": ["consumed", "predator", "behavioural choice"],
                "ablations": placeholder_list[:int((19.8 *len(placeholder_list)) / 20)],
            },
            {
                "assay id": "Ablated-99-2",
                "stimulus paradigm": "Naturalistic",
                "duration": 500,
                "Tethered": False,
                "save frames": True,
