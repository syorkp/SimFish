...
To run:
  ...
  3. run run.py file, from which the configuration can be adjusted.
  4. To test the environment, run run_environment_test.py.
     Note that for Linux this will require installation of tkinter, which can be done using "sudo apt-get install python3-tk"