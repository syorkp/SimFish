...
def compute_light_and_dark_gain(model_config, visual_distance_full, visual_distance_partial,
    ...
    nearest_dark_i = find_nearest(np.array(distinguishability_scores_partial), 0.75)
    nearest_dark = luminance_vals[nearest_dark_i]
    print(f"{nearest_dark}-{distinguishability_scores_full[nearest_dark_i]}")

    nearest_light_i = find_nearest(np.array(distinguishability_scores_full), 0.75)
