...
if __name__ == "__main__":
    ...
    angs = plot_strike_zone(fraction_capture_permitted=0.2, angle_deviation_allowed=np.pi / 6, n_repeats=10,
    ...
    # For DQN
    plot_strike_zone(fraction_capture_permitted=0.2, angle_deviation_allowed=np.pi/6,
                     n_repeats=10,
