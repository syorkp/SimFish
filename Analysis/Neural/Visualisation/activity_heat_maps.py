...
def display_activity_heat_map(rnn_activity, event_timestamps, min_t=0, max_t=-1, normalise_main_activity=True,
    ...
    plt.savefig("heat_map_cell.jpg", dpi=100)
    plt.clf()
    plt.close()
...
if __name__ == "__main__":
    ...
    # display_activity_heat_map(data2["rnn_state_actor"], [200], max_t=1000)
    ...
    display_activity_heat_map(data["rnn_state_actor"], consumption_events)
