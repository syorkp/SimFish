...
def draw_episode(data_file, config_file, continuous_actions=False,  draw_past_actions=True, show_energy_state=True,
    ...
    fig = plt.figure(facecolor='0.9', figsize=(4, 3), dpi=10)
...
if __name__ == "__main__":
    ...
    draw_episode(data_file, config_file, continuous_actions=False, show_energy_state=True,
                 trim_to_fish=True, showed_region_quad=500, save_id="try", include_background=True)
