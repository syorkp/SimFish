...
from Analysis.Behavioural.Tools.BehavLabels.extract_exploration_sequences import label_exploration_sequences_no_prey, \
    label_exploration_sequences_free_swimming
from Analysis.Behavioural.Tools.BehavLabels.extract_wall_interaction_sequences import label_wall_interaction_steps
from Analysis.Behavioural.Tools.BehavLabels.extract_photogradient_sequences import label_in_light_steps, label_hemispheric_light_gradient
from Analysis.Behavioural.Tools.BehavLabels.extract_salt_interaction_sequences import label_salt_health_decreasing
from Analysis.Behavioural.Tools.BehavLabels.extract_energy_state_sequences import label_energy_state_within_range
from Analysis.Behavioural.Tools.BehavLabels.extract_salt_interaction_sequences import label_salt_health_within_range
