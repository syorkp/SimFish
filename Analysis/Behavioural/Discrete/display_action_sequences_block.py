...
if __name__ == "__main__":
    capture_sequences = get_capture_sequences(f"dqn_new-2", "Behavioural-Data-Free", "Naturalistic", 20)
    display_all_sequences(capture_sequences, indicate_consumption=True, save_figure=True, figure_save_location="Captures-dqn_new-2")
