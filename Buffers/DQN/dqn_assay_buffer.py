...
class DQNAssayBuffer(BaseBuffer):
    ...
    def add_training(self, observation, observation_old, internal_state, reward, action, rnn_state, rnn_state_ref, value, value_ref, advantage, advantage_ref):
        self._add_training(observation, observation_old, internal_state, reward, action, rnn_state, rnn_state_ref, value, value_ref, advantage, advantage_ref)
