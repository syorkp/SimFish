...
class PPONetworkActorMultivariate2A(BaseNetwork):
    ...
    def __init__(self, simulation, rnn_dim, rnn_cell, my_scope, internal_states, max_impulse, max_angle_change,
        ...
        self.action_stream = self.rnn_output
        self.action_stream_ref = self.rnn_output_ref
        ...
        self.total_loss = self.policy_loss + self.entropy_loss
...
class PPONetworkActorMultivariate2V(BaseNetwork):
    ...
    def __init__(self, simulation, rnn_dim, rnn_cell, my_scope, internal_states, max_impulse, max_angle_change,
        ...
        self.value_stream = self.rnn_output
        self.value_stream_ref = self.rnn_output_ref
