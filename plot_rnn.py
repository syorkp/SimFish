...
base_path = './Training-Output/prey_very_basic_free-3/episodes/'
episodes = ['Episode 350.h5', 'Episode 400.h5']
...
for episode in episodes:
    ...
    with h5py.File(file_path, "r") as file:
        ...
        rnn = file[group]['rnn_state_actor'][:, 0, :]
        rnn_ref = file[group]['rnn_state_actor_ref'][:, 0, :]
    ...
    right_advantage_steps = np.where(r_vs_l > 2)[0]
