...
indescriminate_ablation_gradient = [
    {
            "Model Name": "even_prey_ref",
            "Environment Name": "prey_only",
            "Trial Number": 7,
...
def build_indescriminate_ablation_gradient_configuration(model_names, ablation_group_names, environment, configuration_name):
    configuration = []
    for group, model in zip(ablation_group_names, model_names):
        gradient_conf_list = indescriminate_ablation_gradient.copy()
