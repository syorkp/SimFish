...
with open(f"Run-Configurations/even_4_ps_prey_only.json", 'r') as f:
    c1 = json.load(f)

with open(f"Run-Configurations/even_4_ps_predator.json", 'r') as f:
    c2 = json.load(f)

with open(f"Run-Configurations/even_5_ps_prey_only.json", 'r') as f:
    c3 = json.load(f)

with open(f"Run-Configurations/even_5_ps_predator.json", 'r') as f:
    c4 = json.load(f)

with open(f"Run-Configurations/even_6_ps_prey_only.json", 'r') as f:
    c5 = json.load(f)

with open(f"Run-Configurations/even_6_ps_predator.json", 'r') as f:
    c6 = json.load(f)

with open(f"Run-Configurations/even_8_ps_prey_only.json", 'r') as f:
    c7 = json.load(f)

with open(f"Run-Configurations/even_8_ps_predator.json", 'r') as f:
    c8 = json.load(f)

target_ablation = c1 + c2 + c3 + c4 + c5 + c6 + c7 + c8
