...
scaffold_training_config_2 = [
    {
        "Model Name": "scaffold_version_2",
        "Environment Name": "ppo_continuous_sbe_is_scaffold_2",
        "Trial Number": 1,
        "Total Configurations": 8,
        "Episode Transitions": {
        },
...
data_gathering = [
    {
        "Model Name": "data_gathering_new",
        "Environment Name": "ppo_continuous_sbe_is_scaffold_1_d",
        "Trial Number": 4,
        "Total Configurations": 8,
        "Episode Transitions": {
        },
...
manager = TrialManager(scaffold_training_config_2b, parallel_jobs=4)
