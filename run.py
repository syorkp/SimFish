...
with open(f"diff_naturalistic_targeted-Prey-Sighted.json", 'r') as f:
    c1 = json.load(f)

with open(f"diff_prey_only_targeted-No-Response.json", 'r') as f:
    c2 = json.load(f)

with open(f"diff_naturalistic_targeted-No-Response.json", 'r') as f:
    c3 = json.load(f)
